...
class ChatResponse(BaseModel):
    ...
    risk_level: Optional[str] = Field(default=None, description="Risk triage level: OPTIMAL, SUB_OPTIMAL, CRITICAL_BLOCKER")
    risk_type: Optional[str] = Field(default=None, description="Type of risk blocker: PATHOLOGY, SUBSTRATE")
    risk_message: Optional[str] = Field(default=None, description="Detailed explanatory message for the risk")
